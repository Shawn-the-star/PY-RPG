...
class UI:
    ...
    def draw_bar(self, current, max_amount, bg_rect, color):
    ...
    def show_exp(self, exp):
        ...
        text_rect = text_surf.get_rect(bottomright = (WIDTH - 20, HEIGTH - 30))

        pygame.draw.rect(self.display_surface, UI_BG_COLOR, text_rect.inflate(20, 20))
        pygame.draw.rect(self.display_surface, UI_BORDER_COLOR, text_rect, 2)
    ...
    def weapon_overlay(self, weapon_index, has_switched):
        bg_rect = self.selection_box(10, 590, has_switched=has_switched)# weapon
    ...
    def magic_overlay(self, magic_index, has_switched):
        bg_rect = self.selection_box(75, 610, has_switched=has_switched)# magic
